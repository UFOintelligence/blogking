              ...
              @isset($item['url'])
                  ...
                  <li>
                    <div class="flex items-center">
                      ...
                      <a href="{{$item['url']}}" class="ms-1 text-sm font-medium
                       text-gray-700 hover:text-blue-600 md:ms-
                       2 dark:text-gray-400 dark:hover:text-white">{{$item['name']}}</a>
                    </div>
                  </li>
             ...
             <li aria-current="page">
                <div class="flex items-center">
                  ...
                  <span class="ms-1 text-sm font-medium
                   text-gray-500 md:ms-2 dark:text-gray-400"> {{$item['name']}}</span>
                </div>
              </li>
              @endisset
